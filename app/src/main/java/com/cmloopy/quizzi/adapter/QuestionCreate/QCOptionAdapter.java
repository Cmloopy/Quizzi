...
public class QCOptionAdapter extends RecyclerView.Adapter<QCOptionAdapter.AnswerViewHolder> {
    ...
    public QCOptionAdapter(Context context, List<Option> answers, OnAnswerClickListener listener) {
    ...
    public AnswerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.ui_qc_item_answer_quiz_type, parent, false);
        return new AnswerViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AnswerViewHolder holder, int position) {
        Option answer = answers.get(position);
