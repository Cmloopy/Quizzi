...
public class QCAnswerAdapter extends RecyclerView.Adapter<QCAnswerAdapter.AnswerViewHolder> {
    ...
    public QCAnswerAdapter(Context context, List<QCAnswer> answers, OnAnswerClickListener listener) {
