...
public class QCPuzzleAnswerAdapter extends RecyclerView.Adapter<QCPuzzleAnswerAdapter.PuzzlePieceViewHolder> {
    private Context context;
    private List<QCAnswer> puzzlePieces;
    private List<QCAnswer> originalPuzzlePieces;
    ...
    public interface OnPuzzlePieceClickListener {
        ...
        void onChangePuzzlePiecePosition(List<QCAnswer> originalPuzzlePieces, List<QCAnswer> newAnswers);
    }

    public QCPuzzleAnswerAdapter(Context context, List<QCAnswer> puzzlePieces, OnPuzzlePieceClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull PuzzlePieceViewHolder holder, int position) {
        QCAnswer puzzlePiece = puzzlePieces.get(position);
...
//        });
        ...
        // Long click listener on the item view
    ...
    public void updatePuzzlePiece(int position, QCAnswer newPuzzlePiece) {
