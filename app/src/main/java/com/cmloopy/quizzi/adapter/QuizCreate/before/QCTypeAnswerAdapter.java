...
public class QCTypeAnswerAdapter extends RecyclerView.Adapter<QCTypeAnswerAdapter.AnswerViewHolder> {
    ...
    public QCTypeAnswerAdapter(Context context, List<QCAnswer> answers, OnAnswerClickListener listener) {
