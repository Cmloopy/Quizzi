...
public class QuestionChoice extends Question implements Serializable {
    ...
    public QuestionChoice(int position, String content, String imageUrl, String audioUrl, int point, int timeLimit, String description, List<ChoiceOption> choiceOptions) {
        super(position, content, imageUrl, audioUrl, point, timeLimit, description);
        this.choiceOptions = choiceOptions;
    }

    public QuestionChoice(int position, Long id, String content, String imageUrl, String audioUrl, int point, int timeLimit, String description, List<ChoiceOption> choiceOptions) {
