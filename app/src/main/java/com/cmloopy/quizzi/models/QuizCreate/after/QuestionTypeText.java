...
public class QuestionTypeText extends Question implements Serializable {
    ...
    public QuestionTypeText(int position, String id, String content, String imageUrl, String audioUrl, int point, int timeLimit, String description, List<TypeTextOption> acceptedAnswers, boolean caseSensitive) {
