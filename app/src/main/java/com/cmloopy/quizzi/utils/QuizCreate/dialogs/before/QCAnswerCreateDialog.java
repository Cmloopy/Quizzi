...
public class QCAnswerCreateDialog {
    ...
    public QCAnswerCreateDialog(Builder builder) {
    ...
    private void setupDialogInteractions(View dialogView, Dialog dialog) {
        ...
        switchCorrect.setOnCheckedChangeListener((buttonView, isChecked) -> {
            ...
            if (isMultipleChoiceQuestion) {
                ...
                for (int i = 0; i < answers.size(); i++) {
                    QCAnswer tmpAnswer = answers.get(i);
    ...
    public static class Builder {
        ...
        public Builder setAnswer(QCAnswer answer) {
            this.answer = answer;
            return this;
        }
        ...
        public Builder setAnswers(List<QCAnswer> answers) {
        ...
        public QCAnswerCreateDialog build() {
            return new QCAnswerCreateDialog(this);
        }
    }
    ...
    public interface OnItemSelectedListener {
        void onItemSelected(int position, QCAnswer answer);
        void onItemSelectedUpdateAll(List<QCAnswer> answer);
    }
}