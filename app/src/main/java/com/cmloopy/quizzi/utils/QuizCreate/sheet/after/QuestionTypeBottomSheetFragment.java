package com.cmloopy.quizzi.utils.QuizCreate.sheet.after;
...
import com.cmloopy.quizzi.adapter.QuizCreate.before.QCQuestionTypeAdapter;
...
public class QuestionTypeBottomSheetFragment extends BottomSheetDialogFragment {
    ...
    public interface OnQuestionTypeSelectedListener {
        void onQuestionTypeSelected(QCQuestionType questionType);
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        List<QCQuestionType> questionTypes = createQuestionTypes();
